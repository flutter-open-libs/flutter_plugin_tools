...
class DeviceInfo(private val packageManager: PackageManager, private val activityManager: ActivityManager) {
    ...
    fun getDeviceInfo() : MutableMap<String, Any> {
        ...
        build["systemFeatures"] = getSystemFeatures(packageManager)
    ...
    private fun getSystemFeatures(packageManager: PackageManager): List<String> {
