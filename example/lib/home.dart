...
class _HomeState extends State<Home> {
        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              buildImTxt(),
              buildDashed(),
              buildSingContainerLinearGradient(),
            ],
          ),
        ),
      ),
  ...
  Widget buildCellItem() {
    return SingCellItem(
        backgroundColor: Colors.white, // 背景颜色，默认透明
        height: 56.0, // item 的高度
        padding: const EdgeInsets.symmetric(horizontal: 16.0),
        assetPath: 'images/example.png', // 前面 icon 的 asset 路径，为空则不展示
  ...
  Widget buildSingContainerLinearGradient(){
    return Container(
      padding: EdgeInsets.symmetric(horizontal: 15.w),
      child: SingContainerLinearGradient(
        width: Get.width - 30.w,
        height: 100.0,
        colors: [AppColor.main, const Color(0xff00ffff)],
        begin: Alignment.topCenter,
        end: Alignment.bottomCenter,
        child:Text('渐变背景的 Container\nSingContainerLinearGradient',style: text_white_18)
      )
    );
  }
}